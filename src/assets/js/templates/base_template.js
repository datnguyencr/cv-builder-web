...
export class BaseTemplate {
    ...
    writeTextWithMarker(
        ...
        for (let i = 0; i < lines.length; i++) {
            ctx.ensureSpace(currentYOffset + lineHeight, (column) => {
                this.addPageFor(ctx, column);
                currentYOffset = 0;
            });
            const y = ctx.y + currentYOffset;
            ...
            if (i === 0 && marker) {
                ...
                marker(baseX, y, markerWidth, lines.length * lineHeight, this);
            }
    ...
    workExpListBlock(
        ...
        this.drawSectionHeader(
            ctx,
            this.cvInfo.sectionHeaders.experience || "Work Experience",
            opts,
        );
    ...
    educationListBlock(
        ...
        this.drawSectionHeader(
            ctx,
            this.cvInfo.sectionHeaders.education || "Education",
            opts,
        );
    ...
    skillListBlock(
        ...
        this.drawSectionHeader(
            ctx,
            this.cvInfo.sectionHeaders.skills || "Skills",
            {
                textColor: textColor,
                indent: indent,
                padding: padding,
    ...
    referenceListBlock(
        ...
        this.drawSectionHeader(
            ctx,
            this.cvInfo.sectionHeaders.references || "References",
            {
                textColor: textColor,
                indent: indent,
                padding: padding,
    ...
    awardListBlock(
        ...
        this.drawSectionHeader(
            ctx,
            this.cvInfo.sectionHeaders.awards || "Awards",
            {
                textColor: textColor,
                indent: indent,
                padding: padding,
    ...
    hobbyListBlock(
        ...
        this.drawSectionHeader(
            ctx,
            this.cvInfo.sectionHeaders.hobbies || "Hobbies",
            {
                textColor: textColor,
                indent: indent,
                padding: padding,
